...
<body>
    <?php
        ...
        $tsql= "execute SCF.del_Gestaciones '$FechaHoraPreñez'";
        $stmt = sqlsrv_prepare($conn, $tsql);
        $result = sqlsrv_execute($stmt);
        if($result == true){
            echo("Gestacion eliminada");
        }else{
    ...
    <div class="Atras">
            <input type="button" value="Atras" onclick="window.location='Del_Gestaciones.html'">
    </div>
</body>
</html>