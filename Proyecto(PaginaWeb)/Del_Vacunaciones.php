...
<body>
    <?php
        ...
        $tsql= "execute SCF.del_Vacunaciones '$FechaHora'";
        $stmt = sqlsrv_prepare($conn, $tsql);
        $result = sqlsrv_execute($stmt);
        if($result == true){
            echo("Vacunacion eliminada");
        }else{
            echo("Vacunacion Inexistente");
        }
    ?>
    <div class="Regresar">
    ...
    <div class="Atras">
            <input type="button" value="Atras" onclick="window.location='Del_Vacunaciones.html'">
    </div>
</body>
</html>