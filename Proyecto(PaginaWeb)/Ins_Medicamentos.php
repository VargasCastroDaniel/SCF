...
<body>
    <?php
        ...
        $tsql= "execute SCF.ins_Medicamentos '$Nombre', '$CantidadDisponible', '$FechaExpiracion', '$Descripcion'";
    ...
    <div class="Atras">
            <input type="button" value="Atras" onclick="window.location='Ins_Medicamentos.html'">
    </div>
</body>
</html>