...
<body>
    <?php
        ...
        $tsql= "execute SCF.ins_Ovulaciones '$FechaHora', '$Descripcion'";
    ...
    <div class="Atras">
            <input type="button" value="Atras" onclick="window.location='Ins_Ovulaciones.html'">
    </div>
</body>
</html>