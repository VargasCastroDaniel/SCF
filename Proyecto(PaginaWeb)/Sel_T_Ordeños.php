...
<body>
    <?php
        ...
        $tsql= "execute SCF.sel_TrabajadoresOrdeños '$Cedula'";
        ...
        if($getResults){
            while ($row = sqlsrv_fetch_array($getResults, SQLSRV_FETCH_ASSOC)) 
            {
                ...
                echo ("Fecha y hora del ordeño: $row[Fechadelordeño]<hr>");
            }
        }else{
    ...
    <div class="Atras">
            <input type="button" value="Atras" onclick="window.location='Sel_T_Ordeños.html'">
    </div>
</body>
</html>