...
<body>
    <?php
        ...
        $tsql= "select * from SCF.view_Trabajadores";
        $getResults= sqlsrv_query($conn, $tsql);
        while ($row = sqlsrv_fetch_array($getResults, SQLSRV_FETCH_ASSOC)) 
        {
            echo ("Nombre Completo: $row[NombreCompleto]<hr>");
            echo ("Cedula: $row[Cedula]<hr>");
            echo("Fecha y Hora del ordeño: $row[FechaHora]<hr>");
