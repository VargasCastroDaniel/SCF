...
<body>
    <?php
        ...
        $tsql= "execute SCF.upd_Ovulaciones '$FechaHora', '$NuevaFechaHora', '$Descripcion'";
    ...
    <div class="Atras">
            <input type="button" value="Atras" onclick="window.location='Upd_Ovulaciones.html'">
    </div>
</body>
</html>