...
<head>
    ...
    <title>Upd_Trabajadores</title>
    <link rel="stylesheet" href="./estilo_button.css">
</head>
<body>
    <?php
        $Cedula=$_GET['Cedula'];
        $CedulaNueva=$_GET['CedulaNueva'];
        $Nombre=$_GET['Nombre'];
        ...
        $tsql= "execute SCF.upd_Trabajadores '$Cedula', '$CedulaNueva', '$Nombre', '$Apellido1', '$Apellido2', '$Telefono'";
    ...
    <div class="Atras">
            <input type="button" value="Atras" onclick="window.location='Upd_Trabajadores.html'">
    </div>
</body>
</html>