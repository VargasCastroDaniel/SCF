...
<head>
    ...
    <title>Ins_Alimentaciones</title>
...
<body>
    <?php
        ...
        $tsql= "execute SCF.ins_Alimentaciones '$FechaHora', '$Tipo', '$Descripcion'";
    ...
    <div class="Atras">
            <input type="button" value="Atras" onclick="window.location='Ins_Alimentaciones.html'">
    </div>
</body>
</html>