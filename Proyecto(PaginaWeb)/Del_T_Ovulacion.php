...
<head>
    ...
    <title>Del_T_Ovulaciones</title>
    <link rel="stylesheet" href="./estilo_button.css">
</head>
<body>
    <?php
        $Cedula = $_GET['Cedula'];
        $FH_Ovulacion = $_GET['FH_Ov'];
        ...
        $tsql= "execute SCF.del_TrabajadoresOvulaciones '$Cedula', '$FH_Ovulacion'";
        $stmt = sqlsrv_prepare($conn, $tsql);
        $result = sqlsrv_execute($stmt);
        if($result == true){
            echo("TrabajadoresOvulaciones eliminada");
        }else{
            echo("TrabajadoresOvulaciones Inexistente");
        }
    ?>
    <div class="Regresar">
    ...
    <div class="Atras">
            <input type="button" value="Atras" onclick="window.location='Del_T_Ovulaciones.html'">
    </div>
</body>
</html>