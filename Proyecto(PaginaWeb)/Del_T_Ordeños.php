...
<body>
    <?php
        ...
        $tsql= "execute SCF.del_TrabajadoresOrdeños '$Cedula', '$FH_Ordeños'";
        $stmt = sqlsrv_prepare($conn, $tsql);
        $result = sqlsrv_execute($stmt);
        if($result == true){
            echo("TrabajadoresOrdeños eliminada");
        }else{
            echo("TrabajadoresOrdeños Inexistente");
        }
    ?>
    <div class="Regresar">
    ...
    <div class="Atras">
            <input type="button" value="Atras" onclick="window.location='Del_T_Ordeños.html'">
    </div>
</body>
</html>