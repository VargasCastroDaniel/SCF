...
<body>
    <?php
        ...
        $tsql= "execute SCF.upd_Vacunaciones '$FechaHora', '$FechaHoraNueva'";
    ...
    <div class="Atras">
            <input type="button" value="Atras" onclick="window.location='Upd_Vacunaciones.html'">
    </div>
</body>
</html>