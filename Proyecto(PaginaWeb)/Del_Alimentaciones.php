...
<head>
    ...
    <title>Del_Alimentaciones</title>
...
<body>
    <?php
        ...
        $tsql= "execute SCF.del_Alimentaciones '$FechaHora'";
        $stmt = sqlsrv_prepare($conn, $tsql);
        $result = sqlsrv_execute($stmt);
        if($result == true){
            echo("Alimentacion eliminada");
        }else{
    ...
    <div class="Atras">
            <input type="button" value="Atras" onclick="window.location='Del_Alimentaciones.html'">
    </div>
</body>
</html>