...
<head>
    ...
    <title>Sel_ResesOvulaciones</title>
...
<body>
    <?php
        ...
        $tsql= "execute SCF.sel_ResesOvulaciones '$IdRes'";
        ...
        if($getResults){
            while ($row = sqlsrv_fetch_array($getResults, SQLSRV_FETCH_ASSOC)) 
            {
                ...
                echo ("Fecha y Hora de la ovulacion: $row[FechayHoradelaovulacion]<hr>");
    ...
    <div class="Atras">
            <input type="button" value="Atras" onclick="window.location='Sel_ResesOvulaciones.html'">
    </div>
</body>
</html>