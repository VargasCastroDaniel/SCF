...
<head>
    ...
    <title>Del_V_Medicamentos</title>
...
<body>
    <?php
        ...
        $tsql= "execute SCF.del_VacunacionesMedicamentos '$Nombre', '$FechaHora'";
        $stmt = sqlsrv_prepare($conn, $tsql);
        $result = sqlsrv_execute($stmt);
        if($result == true){
            echo("VacunacionesMedicamentos eliminada");
        }else{
            echo("VacunacionesMedicamentos Inexistente");
        }
    ?>
    <div class="Regresar">
    ...
    <div class="Atras">
            <input type="button" value="Atras" onclick="window.location='Del_V_Medicamentos.html'">
    </div>
</body>
</html>