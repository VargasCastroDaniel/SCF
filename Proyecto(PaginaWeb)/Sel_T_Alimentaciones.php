...
<head>
    ...
    <title>Sel_T_Alimentaciones</title>
...
<body>
    <?php
        ...
        $tsql= "execute SCF.sel_TrabajadoresAlimentaciones '$Cedula'";
        ...
        if($getResults){
            while ($row = sqlsrv_fetch_array($getResults, SQLSRV_FETCH_ASSOC)) 
            {
                ...
                echo ("Fecha y hora de la alimentacion: $row[Fechadelaalimentacion]<hr>");
            }
        }else{
    ...
    <div class="Atras">
            <input type="button" value="Atras" onclick="window.location='Sel_T_Alimentaciones.html'">
    </div>
</body>
</html>