...
<head>
    ...
    <title>Del_ResesAlimentaciones</title>
...
<body>
    <?php
        ...
        $tsql= "execute SCF.del_ResesAlimentaciones '$IdRes', '$FechaHora'";
        $stmt = sqlsrv_prepare($conn, $tsql);
        $result = sqlsrv_execute($stmt);
        if($result == true){
            echo("ResesAlimentaciones eliminada");
        }else{
            echo("ResesAlimentaciones Inexistente");
        }
    ?>
    <div class="Regresar">
    ...
    <div class="Atras">
            <input type="button" value="Atras" onclick="window.location='Del_ResesAlimentaciones.html'">
    </div>
</body>
</html>