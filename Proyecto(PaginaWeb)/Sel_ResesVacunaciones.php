...
<head>
    ...
    <title>Sel_ResesVacunaciones</title>
...
<body>
    <?php
        ...
        $tsql= "execute SCF.sel_ResesVacunaciones '$IdRes'";
    ...
    <div class="Atras">
            <input type="button" value="Atras" onclick="window.location='Sel_ResesVacunaciones.html'">
    </div>
</body>
</html>