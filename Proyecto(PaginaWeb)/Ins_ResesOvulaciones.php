...
<body>
    <?php
        ...
        $tsql= "execute SCF.ins_ResesOvulaciones '$IdRes', '$FechaHora'";
        ...
        if($stmt){
            ...
            if ($result2 == "El Id de la res o La fecha de la ovulacion no existe"){
                echo($result2);
                echo($espacio);
            }else{
    ...
    <div class="Atras">
            <input type="button" value="Atras" onclick="window.location='Ins_ResesOvulaciones.html'">
    </div>
</body>
</html>