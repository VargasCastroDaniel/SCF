...
<head>
    ...
    <title>Del_ResesVacunaciones</title>
...
<body>
    <?php
        ...
        $tsql= "execute SCF.del_ResesVacunaciones '$IdRes', '$FechaHora'";
        $stmt = sqlsrv_prepare($conn, $tsql);
        $result = sqlsrv_execute($stmt);
        if($result == true){
            echo("ResesVacunaciones eliminada");
        }else{
            echo("ResesVacunaciones Inexistente");
        }
    ?>
    <div class="Regresar">
    ...
    <div class="Atras">
            <input type="button" value="Atras" onclick="window.location='Del_ResesVacunaciones.html'">
    </div>
</body>
</html>