...
<body>
    <?php
        ...
        $tsql= "execute SCF.del_ResesOvulaciones '$IdRes', '$FechaHora'";
        $stmt = sqlsrv_prepare($conn, $tsql);
        $result = sqlsrv_execute($stmt);
        if($result == true){
            echo("ResesOvulaciones eliminada");
        }else{
            echo("ResesOvulaciones Inexistente");
        }
    ?>
    <div class="Regresar">
    ...
    <div class="Atras">
            <input type="button" value="Atras" onclick="window.location='Del_ResesOvulaciones.html'">
    </div>
</body>
</html>