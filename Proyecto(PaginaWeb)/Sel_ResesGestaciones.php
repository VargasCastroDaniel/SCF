...
<body>
    <?php
        ...
        $tsql= "execute SCF.sel_ResesGestaciones '$IdRes'";
        ...
        if($getResults){
            while ($row = sqlsrv_fetch_array($getResults, SQLSRV_FETCH_ASSOC)) 
            {
                ...
                echo ("Fecha y Hora de la preñez: $row[FechayHoradelapreñez]<hr>");
            }
        }else{
    ...
    <div class="Atras">
            <input type="button" value="Atras" onclick="window.location='Sel_ResesGestaciones.html'">
    </div>
</body>
</html>