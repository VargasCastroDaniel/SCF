...
<body>
    <?php
        ...
        $tsql= "execute SCF.del_Ordeños '$FechaHora'";
        $stmt = sqlsrv_prepare($conn, $tsql);
        $result = sqlsrv_execute($stmt);
        if($result == true){
            echo("Ordeño eliminado");
        }else{
    ...
    <div class="Atras">
            <input type="button" value="Atras" onclick="window.location='Del_Ordeños.html'">
    </div>
</body>
</html>