...
<head>
    ...
    <title>Del_T_Alimentaciones</title>
...
<body>
    <?php
        ...
        $tsql= "execute SCF.del_TrabajadoresAlimentaciones '$Cedula', '$FH_Alimentaciones'";
        $stmt = sqlsrv_prepare($conn, $tsql);
        $result = sqlsrv_execute($stmt);
        if($result == true){
            echo("TrabajadoresAlimentaciones eliminada");
        }else{
            echo("TrabajadoresAlimentaciones Inexistente");
        }
    ?>
    <div class="Regresar">
    ...
    <div class="Atras">
            <input type="button" value="Atras" onclick="window.location='Del_T_Alimentaciones.html'">
    </div>
</body>
</html>