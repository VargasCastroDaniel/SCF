...
<head>
    ...
    <title>Del_ResesOvulaciones</title>
...
<body>
    <?php
        ...
        $tsql= "execute SCF.del_ResesGestaciones '$IdRes', '$FechaHoraPreñez'";
        $stmt = sqlsrv_prepare($conn, $tsql);
        $result = sqlsrv_execute($stmt);
        if($result == true){
            echo("ResesGestaciones eliminada");
        }else{
            echo("ResesGestaciones Inexistente");
        }
    ?>
    <div class="Regresar">
    ...
    <div class="Atras">
            <input type="button" value="Atras" onclick="window.location='Del_ResesGestaciones.html'">
    </div>
</body>
</html>