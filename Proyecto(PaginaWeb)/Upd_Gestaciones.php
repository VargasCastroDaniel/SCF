...
<body>
    <?php
        ...
        $tsql= "execute SCF.upd_Gestaciones '$FechaHoraPreñez', '$NuevaFechaHoraPreñez', '$RazaPadrote'";
    ...
    <div class="Atras">
            <input type="button" value="Atras" onclick="window.location='Upd_Gestaciones.html'">
    </div>
</body>
</html>