...
<body>
    <?php
        ...
        $tsql= "execute SCF.sel_TrabajadoresPastoreos '$Cedula'";
    ...
    <div class="Atras">
            <input type="button" value="Atras" onclick="window.location='Sel_T_Pastoreos.html'">
    </div>
</body>
</html>