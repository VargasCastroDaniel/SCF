...
<head>
    ...
    <title>Del_ResesPastoreos</title>
...
<body>
    <?php
        ...
        $tsql= "execute SCF.del_ResesPastoreos '$IdRes', '$NumeroLote'";
        $stmt = sqlsrv_prepare($conn, $tsql);
        $result = sqlsrv_execute($stmt);
        if($result == true){
            echo("ResesPastoreos eliminada");
        }else{
            echo("ResesPastoreos Inexistente");
        }
    ?>
    <div class="Regresar">
    ...
    <div class="Atras">
            <input type="button" value="Atras" onclick="window.location='Del_ResesPastoreos.html'">
    </div>
</body>
</html>