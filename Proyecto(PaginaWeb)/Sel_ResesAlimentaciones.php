...
<head>
    ...
    <title>Sel_ResesAlimentaciones</title>
...
<body>
    <?php
        ...
        $tsql= "execute SCF.sel_ResesAlimentaciones '$IdRes'";
        ...
        if($getResults){
            while ($row = sqlsrv_fetch_array($getResults, SQLSRV_FETCH_ASSOC)) 
            {
                ...
                echo ("Fecha y Hora de la alimentacion: $row[FechayHoradelaalimentacion]<hr>");
            }
        }else{
    ...
    <div class="Atras">
            <input type="button" value="Atras" onclick="window.location='Sel_ResesAlimentaciones.html'">
    </div>
</body>
</html>