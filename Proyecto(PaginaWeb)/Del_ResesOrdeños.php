...
<body>
    <?php
        ...
        $tsql= "execute SCF.del_ResesOrdeños '$IdRes', '$FechaHora'";
        $stmt = sqlsrv_prepare($conn, $tsql);
        $result = sqlsrv_execute($stmt);
        if($result == true){
            echo("ResesOrdeños eliminada");
        }else{
            echo("ResesOrdeños Inexistente");
        }
    ?>
    <div class="Regresar">
    ...
    <div class="Atras">
            <input type="button" value="Atras" onclick="window.location='Del_ResesOrdeños.html'">
    </div>
</body>
</html>